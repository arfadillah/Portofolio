...
export default {
  data() {
    return {
      ...
      items: [
        {
          id: 1,
          name: 'Bons-AI:Smart Automation System For Watering, Fertilizing, and Monitoring Bonsai Types',
          imageUrl: 'gambar1',
          status: 'Bons-Al is an automation tool for bonsai care. The integration of loT and Al is applied to analyze the shape of bonsai and provide automation of the process of watering, fertilizing, and monitoring the condition of bonsai with sensors embedded around the bonsai to collect data about soil moisture and temperature.',
          tech: '',
          github: '',
          demo: ''
        },
        {
          id: 2,
          name: 'Booth Booking Information System (MyEvent)',
          imageUrl: 'gambar2',
          status: 'My Event is a website-based platform and mobile application that helps MSMEs find events around them for booth registration and helps event organizers manage booth registrants..',
          tech: '',
          github: '',
          demo: ''
        },
        {
          id: 3,
          name: 'Boarding Room Information Management System',
          imageUrl: 'gambar3',
          status: 'The application of the Boarding Room Information Management System is a web-based boarding house payment application that aims to improve efficiency and convenience in payment management for users (owners) and tenants. Through the implementation of an online payment system, increasing security and efficiency in the transaction process, and providing residents with the convenience of making payments electronically.',
          tech: '',
          github: '',
          demo: ''
        },
  ...
  getImagePath(filename) {
    return require(`@/assets/image/${filename}.jpg`);
  }
}
