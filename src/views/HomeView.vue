<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200"></p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Arya Fadillah Agustin Ningrum</h1>
      <div class="py-2">
        <h1
  ...
  <img
    :src="require('@/assets/image/arya.jpg')"
    alt="avatar"
    width="300"
    height="300"
...
export default {
  ...
  data() {
    return {
      toRotate: ["Sofware Quality Assurance"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
