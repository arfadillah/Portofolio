    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
         <img :src="require('@/assets/image/arya.jpg')" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; I am a seventh-semester student in the Informatics Engineering program at Politeknik Negeri Jember, with a strong interest in Quality
Assurance (QA) and software testing. I am passionate about ensuring the reliability, functionality, and performance of software applications
through meticulous testing and analysis. I am committed to improving software quality by conducting in-depth testing, identifying bugs, and
optimizing processes to enhance user satisfaction. With a strong willingness to learn and grow, I am ready to contribute to developing
high-quality, efficient, and user-friendly digital solutions.
